...
final class CurrencyBridge {
	...
	private static function registry(): array {
		 ...
		 */
		return (array) apply_filters( 'pkitfw_currency_adapters', $list );
	}
	...
	public static function convert( float $price ): float {
		 ...
		 */
		return (float) apply_filters( 'pkitfw_currency_convert', $result, $price, $adapter );
	}
	...
	public static function revert( float $price ): float {
		 ...
		 * @param CurrencyAdapter|null $adapter Active adapter (or null).
		 */
		return (float) apply_filters( 'pkitfw_currency_revert', $result, $price, $adapter );
	}
