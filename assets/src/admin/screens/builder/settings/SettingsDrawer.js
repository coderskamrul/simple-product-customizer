...
const TABS = [
	{
		key: 'general',
		label: __( 'General', 'simple-product-customizer' ),
	},
	{
		key: 'styles',
		label: __( 'Styles', 'simple-product-customizer' ),
	},
	{
		key: 'logic',
		label: __(
				...
				{ open && (
					...
					>
						...
						>
							...
							<div className="spcus-drawer__tabs" role="tablist">
								{ TABS.map( ( t ) => (
									<button
										key={ t.key }
										type="button"
							...
							<div className="spcus-drawer__body">
