 ...
 * inside the same React mount (`#spcus-admin-root`); the submenu entries
...
final class AdminMenu {
	...
	public function register() {
		...
		add_filter( 'plugin_action_links_' . SPCUS_BASENAME, array( $this, 'action_links' ) );
	}
	...
	public function register_menu() {
		...
		add_menu_page(
			esc_html__( 'Product Options', 'simple-product-customizer' ),
			esc_html__( 'Product Options', 'simple-product-customizer' ),
			$cap,
			self::SLUG,
			array( $this, 'render' ),
		...
		$submenus = array(
			array( self::SLUG, esc_html__( 'Dashboard', 'simple-product-customizer' ) ),
	...
	public function render() {
		echo '<div class="wrap spcus-admin-wrap">';
		echo '<h1 class="screen-reader-text">' . esc_html__( 'Product Options', 'simple-product-customizer' ) . '</h1>';
		echo '<div id="spcus-admin-root"></div>';
		echo '</div>';
	}
	...
	public function action_links( $links ) {
		...
		$entry = '<a href="' . esc_url( $url ) . '">' . esc_html__( 'Option Sets', 'simple-product-customizer' ) . '</a>';
	...
	public static function is_app_screen() {
		...
		// Top-level: toplevel_page_spcus-options. Submenus share the same base.
