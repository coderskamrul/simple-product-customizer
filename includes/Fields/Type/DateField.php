...
final class DateField extends AbstractField {
	...
	protected function inner() {
		...
		$input = '<input type="text" readonly class="pkitfw-input pkitfw-date-input" name="' . esc_attr( $this->input_name() ) . '"'
			. $this->attrs(
				array_merge(
					array(
		...
		return '<div class="pkitfw-date">'
			. '<span class="pkitfw-date__icon" aria-hidden="true">'
