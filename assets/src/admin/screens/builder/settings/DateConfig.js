...
const RANGE_MODES = [
	{
		value: 'none',
		label: __( 'None', 'simple-product-customizer' ),
	},
	{
		value: 'today',
		label: __( 'Today', 'simple-product-customizer' ),
	},
	{
		value: 'custom',
		label: __( 'Custom', 'simple-product-customizer' ),
	},
];

/** Weekday chips (index = PHP/flatpickr day-of-week, 0 = Sunday). */
const WEEKDAYS = [
	{ value: 0, label: __( 'Sun', 'simple-product-customizer' ) },
	{ value: 1, label: __( 'Mon', 'simple-product-customizer' ) },
	{ value: 2, label: __( 'Tue', 'simple-product-customizer' ) },
	{ value: 3, label: __( 'Wed', 'simple-product-customizer' ) },
	{ value: 4, label: __( 'Thu', 'simple-product-customizer' ) },
	{ value: 5, label: __( 'Fri', 'simple-product-customizer' ) },
	{ value: 6, label: __( 'Sat', 'simple-product-customizer' ) },
];
		...
		<>
			...
			<div className="spcus-settings__group">
				...
				{ disableDates.length > 0 && (
					<div className="spcus-daychips spcus-daychips--dates">
						{ disableDates.map( ( d ) => (
							<span key={ d } className="spcus-datechip">
								{ d }
								<button
									type="button"
									aria-label={ __(
